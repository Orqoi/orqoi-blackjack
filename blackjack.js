...
startBtn.addEventListener("click", function(){
	...
	document.querySelector(".all-in").onclick = () => increment(player.balance);
	...
	function displayAll(){
		let cardImages = document.querySelectorAll(".dealer-cards > img");
		for (let i = 0; i < computer.cards.length; i++){
			computer.cards[i].display();
			cardImages[i].src = computer.cards[i].src();
		}
	}
	...
	function gameEnd(){
		...
		endButton.setAttribute('class', 'end-btn');
...
class Computer{
	...
	draw(deck, numCards, hidden=false){
...
/*
TODO:
1. write more comments, segment and clean up code
2. add more aesthetics
3. add double down
4. add fade effect
*/
